...
class _HomeScreenState extends State<HomeScreen> {
  late Future<List<AdvertisementJob>> _jobsFuture;  // ✅ تغيير النوع إلى List<AdvertisementJob>
        ...
        child: CustomScrollView(
          slivers: [
            ...
            if (!_isConnected)
              ...
              FutureBuilder<List<AdvertisementJob>>(  // ✅ تغيير النوع هنا
                future: _jobsFuture,
                builder: (context, snapshot) {
                  ...
                  // ✅ هنا أصبح snapshot.data! من النوع List<AdvertisementJob>
